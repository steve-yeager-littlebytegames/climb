...
export class LeagueApi extends BaseClass {
    ...
    sets(leagueID: number, dueDate: Date): Promise<SetDto[]> {
        let url_ = this.baseUrl + "/api/v1/leagues/sets?";
        if (leagueID === undefined || leagueID === null)
            throw new Error("The parameter 'leagueID' must be defined and cannot be null.");
        else
            url_ += "leagueID=" + encodeURIComponent("" + leagueID) + "&"; 
        if (dueDate === undefined || dueDate === null)
            throw new Error("The parameter 'dueDate' must be defined and cannot be null.");
        else
    ...
    getRecentCharacters(leagueUserID: number, characterCount: number): Promise<CharacterDto[]> {
        let url_ = this.baseUrl + "/api/v1/leagues/recent-characters?";
        if (leagueUserID === undefined || leagueUserID === null)
            throw new Error("The parameter 'leagueUserID' must be defined and cannot be null.");
        else
            url_ += "leagueUserID=" + encodeURIComponent("" + leagueUserID) + "&"; 
        if (characterCount === undefined || characterCount === null)
            throw new Error("The parameter 'characterCount' must be defined and cannot be null.");
        else
...
export class SeasonApi extends BaseClass {
    ...
    updateStandings(seasonID: number): Promise<FileResponse | null> {
